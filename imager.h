...
/* colour manipulation */
extern i_img *i_convert(i_img *src, const double *coeff, int outchan, int extraoutchans, int inchan, int linear);
...
extern i_img *
im_lin_img_double_new_extra(pIMCTX, i_img_dim x, i_img_dim y, int ch, int extra);
extern i_img *i_img_to_linrgbdbl(i_img *im);
